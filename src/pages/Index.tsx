...
const Index = () => {
  return (
    <div className="h-screen bg-black text-white flex flex-col items-center justify-between px-4 py-6 overflow-hidden">
      {/* Logo */}
      ...
      {/* Event Teaser */}
      <div className="text-center animate-fade-in flex-shrink-0" style={{ animationDelay: "0.2s" }}>
      ...
      {/* CTA Buttons */}
      <div className="flex flex-col sm:flex-row gap-3 animate-fade-in flex-shrink-0" style={{ animationDelay: "0.4s" }}>
        <Button className="bg-white/10 backdrop-blur-sm border border-white/30 text-white hover:bg-white hover:text-black hover:scale-105 active:scale-95 transition-all duration-300 px-6 py-4 text-xs uppercase tracking-wider" onClick={() => window.open("/subscribe", "_blank")}>
          Sign Up
        </Button>
      ...
      {/* Footer */}
      <div className="text-center animate-fade-in flex-shrink-0" style={{ animationDelay: "0.6s" }}>
