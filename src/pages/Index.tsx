      ...
      <div className="flex flex-col items-center gap-0 md:gap-0 flex-shrink-0 z-10">
        <div className="animate-scale-in mt-2 mb-1 sm:mb-0">
          <img
            ...
            className="w-auto h-auto max-h-[18vh] max-w-[90vw] sm:max-h-[18vh] sm:max-w-[80vw] md:max-h-[14vh] md:max-w-[32vw] drop-shadow-[0_0_6px_rgba(255,255,255,0.35)] logo-white logo-float"
          />
        </div>
